...
function OAuth2Strategy(options, verify) {
  ...
  // Monkey Patching this function to overcome the header issues with implementation
  // of OAuth2
  this._oauth2._executeRequest = function (http_library, options, post_body, callback) {
    var allowEarlyClose= false; //OAuthUtils.isAnEarlyCloseHost(options.host);
    ...
    var postparams = JSON.parse(JSON.stringify(qs.parse(post_body)));
    const reqOptions = {
